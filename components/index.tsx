...
export const Heading1 = ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => <h1 className="font-accent font-bold text-4xl">{children}</h1>;

export const Heading2 = ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => <h2 className="font-accent font-bold text-3xl">{children}</h2>;

export const Heading3 = ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => <h3 className="font-accent font-bold text-2xl">{children}</h3>;

export const Heading4 = ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => <h4 className="font-accent font-bold text-base">{children}</h4>;

export const Text = ({ children, ...rest }: React.HTMLAttributes<HTMLParagraphElement>) => <p className="font-main text-base" {...rest}>{children}</p>;
...
export const Link = ({ children, value }: React.ComponentProps<typeof CustomLink>) => <CustomLink value={value}>{children}</CustomLink>;
